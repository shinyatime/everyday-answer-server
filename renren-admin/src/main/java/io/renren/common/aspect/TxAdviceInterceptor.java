...
public class TxAdviceInterceptor {
    ...
    //private static final String AOP_POINTCUT_EXPRESSION = "execution (* com.zenith..rpc.service.*.*(..))";
    private static final String AOP_POINTCUT_EXPRESSION = "execution (* io.renren.modules..service.*.*(..))";
